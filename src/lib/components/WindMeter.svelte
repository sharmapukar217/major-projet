...
<div class="rounded-xl border bg-card text-card-foreground shadow p-6">
  ...
  <div class="flex justify-center p-0 font-semibold md:text-lg" class:animate-pulse={!data}>
    <div class="relative -mt-5 flex h-[10rem] w-[10rem] items-center justify-center">
      {#if data?.speed}
        <div class="absolute text-sm font-semibold">
          {Math.round((data.speed * 1000.0) / 3600)}m/s
        </div>
      {/if}
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331 331" class="absolute">
        <g fill="none" fill-rule="evenodd" opacity=".401">
          ...
          <path
            ...
            transform="translate(154 31)" />
          <g stroke="hsl(var(--color-foreground))" stroke-linecap="square" stroke-linejoin="bevel">
            <path
          ...
          <g class="fill-foreground" font-size={36} font-weight="bold">
            <text transform="translate(60 60)">
              <tspan x="92.501" y={33} fill="hsl(var(--color-foreground))"> N </tspan>
            </text>
            <text transform="translate(60 60)">
              <tspan x="178.494" y={118} fill="hsl(var(--color-foreground))"> E </tspan>
            </text>
            <text transform="translate(60 60)">
              <tspan x="93.494" y={203} fill="hsl(var(--color-foreground))"> S </tspan>
            </text>
            <text transform="translate(60 60)">
              <tspan x="3.511" y={118} fill="hsl(var(--color-foreground))"> W </tspan>
            </text>
          </g>
        </g>
      </svg>
      ...
      {#if data?.deg}
        <svg
          ...
          class="absolute transition-transform ease-in-out will-change-transform fill-foreground">
          <path
